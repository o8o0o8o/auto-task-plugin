...
default_for() {
  case "${1:-}" in
    ...
    release_mode)                 printf 'skip' ;;
    release_command)              printf '' ;;
    ...
    analyzer_command)             printf '' ;;
    analyzer_timeout_sec)         printf '120' ;;
    ...
    external_actions_mode)        printf 'ask' ;;
    external_actions_timeout_min) printf '30' ;;
    external_actions_poll_interval_sec) printf '60' ;;
    ...
    worktree_cleanup_nudge)       printf 'true' ;;
    worktree_cleanup_throttle_hours) printf '24' ;;
    worktree_cleanup_prune_dirty) printf 'false' ;;
    worktree_stale_days_default)  printf '14' ;;
    worktree_stale_days_feat)     printf '30' ;;
    worktree_stale_days_refactor) printf '30' ;;
    worktree_stale_days_fix)      printf '14' ;;
    worktree_stale_days_chore)    printf '7' ;;
    worktree_stale_days_deps)     printf '7' ;;
    worktree_stale_days_docs)     printf '7' ;;
    worktree_stale_days_cleanup)  printf '7' ;;
...
defaults_json() {
  jq -n \
    ...
    analyzer_command: "",
    analyzer_timeout_sec: 120,
    shadow_review: false,
    bot_review_autofix: false,
    bot_review_timeout_min: 10,
    bot_review_poll_interval_sec: 30,
    bot_review_bots: "",
    external_actions_mode: "ask",
    external_actions_timeout_min: 30,
    external_actions_poll_interval_sec: 60,
