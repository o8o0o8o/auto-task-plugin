...
SKILLS=(auto-task auto-task-plan auto-task-implement auto-task-verify auto-task-code-review auto-task-commit auto-task-fix auto-task-docs auto-task-stats auto-task-gc auto-task-resume)
