...
flowchart TD
    ...
    GateBCls -- "2nd self_inflicted pass,<br/>or CONVERGED (count stopped falling)<br/>— only on a reopening pass; a zero-<br/>reopening pass takes the clean exit" --> GateBSurface
